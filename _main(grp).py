...
It looks like you haven't join our group yet.
Please make sure you join in order to use this bot!
'''
...
#? Wrapper for Group Member Control
...
#??????????????????????????????????????????????????????????????????????????????????????????????????
#? This version allows you to Force user to join admin's group
#??????????????????????????????????????????????????????????????????????????????????????????????????
##******************************************************* MAIN FUNCTION ******************************************************
def main():
